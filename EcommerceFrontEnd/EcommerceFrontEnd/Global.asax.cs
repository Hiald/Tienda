...
namespace EcommerceFrontEnd
{
    ...
    {
        public static string wsRoutepizarra = System.Web.Configuration.WebConfigurationManager.AppSettings["routews"].ToString();
        ...
        protected void Application_Error(object sender, EventArgs e)
        {
            ...
            string redirectUrl = urlHelper.Action("Index", "Landing", new { Error = CodigoError });
